...
parser.add_argument('--data_dir', default='D:\\BaiduNetdiskDownload\\MINI\\8Kdehaze_supermini.zip\\8Kdehaze_supermini', type=str, help='path to dataset')
...
if __name__ == '__main__':
    ...
    # 邮件通知
    sender_email = "577096163@qq.com"
    sender_password = "cltrjpyabnhubbea"
    receiver_email = "17710162723@163.com"
